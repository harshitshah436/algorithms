...
/**
 * Implementation of a classifier model using Decision Tree ID3
 * 
 * @author Harshit Shah
 */
...
public class ID3 {
	...
	public void displayClassificationRules(TreeNode node, String string) {
		...
		for (int i = 0; i < size; i++) {
			System.out.println(string + attributeNames[node.rootAttribute]
	...
	public static void main(String[] args) throws Exception {
		...
		String filename = "weather.nominal.csv";
		...
		filename = "weather.numeric.arff.csv";
